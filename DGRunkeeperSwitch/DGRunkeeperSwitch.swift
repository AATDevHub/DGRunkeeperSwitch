...
open class DGRunkeeperSwitch: UIControl {
    ...
    open var selectedBackgroundWidthFix: CGFloat = 0 {
        didSet { setNeedsLayout() }
    }
    ...
    open var titleTopInset: CGFloat = 0 {
        didSet { setNeedsLayout() }
    }

    open var titleXMargin: CGFloat = 0 {
        didSet { setNeedsLayout() }
    }
    ...
    fileprivate(set) open var selectedBackgroundView = UIView()
